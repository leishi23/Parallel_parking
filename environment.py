...
class Environment:
    def __init__(self,obstacles):
        ...
        self.color = np.array([0,255,0])/255
...
class Parking1:
    def __init__(self, car_pos):
        ...
        self.walls = [[55,i] for i in range(10,90) ]+\
                     [[30,i] for i in range(10,105)]+\
                     [[i,10] for i in range(30,65) ]+\
                     [[i,85] for i in range(45,65) ]+\
                     [[i,95] for i in range(30,45) ]
        self.obs = np.array(self.walls)
        self.cars = {1 : [[35,20]], 7 : [[50,20]], 13: [[60,20]],
                     2 : [[35,32]], 8 : [[50,32]], 14: [[60,32]],
                     3 : [[35,44]], 9 : [[50,44]], 15: [[60,44]],
                     4 : [[35,56]], 10: [[50,56]], 16: [[60,56]],
                     5 : [[35,68]], 11: [[50,68]], 17: [[60,68]],
                     6 : [[35,80]], 12: [[50,80]], 18: [[60,80]],}
##        self.cars = {1 : [[40,25]], 2 : [[50,25]], 3 : [[60,25]]}
